...
(function(){
            ...
            enlarge:function(u,v){
                switch(u){
                    ...
                    case 2:case 3:
                        ...
                        var N=new d.walker(M),O,P,Q=d.walker.blockBoundary(u==3?{
                            br:1
                        }:null),R=function(X){
                            var Y=Q(X);
                            if(!Y)O=X;
    ...
    (function(){
        function m(v,w){
            var x=[];
            if(!w)return v;else for(var y in w)x.push(y+'='+encodeURIComponent(w[y]));return v+(v.indexOf('?')!=-1?'&':'?')+x.join('&');
        };
    ...
    (function(){
        ...
        function E(L){
            return function(M){
                ...
                if(Q&&(Q.name&&Q.name=='br'||Q.value&&(R=Q.value.match(C)))){
                    ...
                    else if(S.name=='br')N.splice(O-1,1);else S.value=S.value.replace(C,'');
                }
            };
        ...
        for(var G in B.$listItem)F.elements[G]=E();var H={
            elements:{}
        };

        for(G in B.$listItem)H.elements[G]=E(true);function I(L){
            ...
            j.add('wysiwygarea',{
                ...
                init:function(C){
                    ...
                    if(a.document.$.documentMode>=8){
                        ...
                        var I=[];
                        for(var J in f.$removeEmpty)I.push('html.CSS1Compat '+J+'[contenteditable=false]');C.addCss(I.join(',')+'{ display:inline-block;}');
                    }else if(b.gecko){
            ...
            a.dialog.prototype={
                ...
                show:function(){
                    ...
                    for(var W in {
                        ...
                        keydown:1,
                        keypress:1
                    })S.on(W,R);M(this,this,'\x1b',null,function(){
                    ...
                    showBlock:function(p,q,r,s,t){
                        ...
                        e.setTimeout(function(){
                            var E=e.bind(function(){
                                ...
                                if(A){
                                    if(P<N)if(Q>N)B+=N;
                                        else if(M.width>N)B-=L.left;else B=B-L.right+M.width;
                                }else if(P<N)if(Q>N)B-=N;
                                    else if(M.width>N)B=B-L.right+M.width;else B-=L.left;
                                var R=M.height-L.top,S=L.top;
                                if(R<O)if(S>O)C-=O;
                                    else if(M.height>O)C=C-L.bottom+M.height;else C-=L.top;
                                if(c){
            ...
            d.selection.prototype={
                ...
                getSelectedElement:function(){
                    ...
                    var A=this,B=e.tryThese(function(){
                        ...
                        var C,D,E=A.getRanges()[0],F=E.getCommonAncestor(1,1),G={
                            table:1,
                            ul:1,
                            ol:1,
                            dl:1
