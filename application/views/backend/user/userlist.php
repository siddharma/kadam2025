                    ...
                    <form name="frm_users" id="frm_users" action="<?php echo base_url(); ?>backend/user/list" method="post">
                        ...
                        <div class="box-content">
                            <table  class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <th width="5%" class="workcap">User Id</th>
                                <th width="10%" class="workcap">Name</th>
                                
                                <th width="5%" class="workcap">Sponser Id</th>   
                                <th width="8%" class="workcap">Email</th>   
                                
                                <th width="7%" class="workcap">Phone No</th>   
                                ...
                                <tbody>
                                    ...
                                    <td class="worktd"  align="left"><?php echo stripslashes($user['user_count']); ?></td>                                    
